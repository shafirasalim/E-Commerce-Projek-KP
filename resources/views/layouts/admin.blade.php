        ...
        <aside class="w-64 bg-gray-900 text-white flex-shrink-0 flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto py-6">
                <ul class="space-y-2 px-4">
                    ...
                    {{-- ===== MENU LAPORAN (BARU) ===== --}}
                    <li>
                        <a href="{{ route('admin.reports.index') }}" class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.reports.*') ? 'bg-brand-600 text-white' : 'hover:bg-gray-800 text-gray-300' }} transition">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
